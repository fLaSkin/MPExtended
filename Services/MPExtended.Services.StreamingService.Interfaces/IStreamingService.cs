...
namespace MPExtended.Services.StreamingService.Interfaces
{
    ...
    public interface IStreamingService
    {
        ...
        [OperationContract]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare)]
        Stream GetImageResized(WebMediaType type, int? provider, string id, int maxWidth, int maxHeight, bool? addBorders);
        ...
        [OperationContract]
        [WebGet(BodyStyle = WebMessageBodyStyle.Bare)]
        Stream GetArtworkResized(WebMediaType mediatype, int? provider, string id, WebFileType artworktype, int offset, int maxWidth, int maxHeight, bool? addBorders);
    }
}
